...
//{
//    internal static TypeDesc StringTypeDesc { get; set; } = TypeScope.GetTypeDesc(typeof(string));
//    internal static TypeDesc QnameTypeDesc { get; set; } = TypeScope.GetTypeDesc(typeof(XmlQualifiedName));
...
//        {
//            foreach (var mapping in scope.TypeMappings)
//            {
