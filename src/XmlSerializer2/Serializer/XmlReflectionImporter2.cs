...
namespace System.Xml.Serialization
{
    ...
    /// </devdoc>
    internal class XmlReflectionImporter2
    {
        ...
        private TypeMapping ImportTypeMapping(TypeModel model, string? ns, ImportContext context, string dataType, XmlAttributes? a, bool repeats, bool openModel, RecursionLimiter limiter)
        {
            try
            {
                ...
                if ((a.GetXmlFlags() & ~(XmlAttributeFlags.Type | XmlAttributeFlags.Root)) != 0)
                ...
                switch (model.TypeDesc.Kind)
                {
                    ...
                    case TypeKind.Primitive:
                        if (a.GetXmlFlags() != 0) throw InvalidAttributeUseException(model.Type);
                    ...
                    default:
                        if (model.TypeDesc.Kind == TypeKind.Serializable)
                        {
                            ...
                            if ((a.GetXmlFlags() & ~XmlAttributeFlags.Root) != 0)
                            {
            ...
            [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.PublicMethods)] Type type)
        {
            ...
            if (provider.MethodName is null)
            {
            ...
            MethodInfo? getMethod = getMethod = type.GetTypeInfo().GetDeclaredMethod(provider.MethodName);//.GetMethod(provider.MethodName, /* BindingFlags.DeclaredOnly | */ BindingFlags.Static | BindingFlags.Public, new Type[] { typeof(XmlSchemaSet) });
            if (getMethod == null)
                ...
                if (attrs.Length > 0)
                {
                    ...
                    if (qname != null && !qname.IsEmpty)
                    {
                        ...
                        else
                        {
                            ...
                            if (xsdType != null)
                                SetBase(serializableMapping, xsdType.GetDerivedFrom());
        ...
        internal void SetBase(SerializableMapping mapping, XmlQualifiedName baseQname)
        {
            ...
            if (_serializables![baseQname] == null)
            {
                ...
                SetBase(baseMapping, t.GetDerivedFrom());
        ...
        private ConstantMapping? ImportConstantMapping(ConstantModel model)
        {
            ...
            if ((a.GetXmlFlags() & ~XmlAttributeFlags.Enum) != 0)
        ...
        private void ImportAccessorMapping(MemberMapping accessor, FieldModel model, XmlAttributes a, string? ns, Type? choiceIdentifierType, bool rpc, bool openModel, RecursionLimiter limiter)
        {
            ...
            XmlAttributeFlags flags = a.GetXmlFlags();
